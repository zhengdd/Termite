...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.toTwoActivty).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mToTwo = new Intent("com.dongdong.animal.app2.twoactivity");
                startActivity(mToTwo);
            }
        });
        ...
        findViewById(R.id.sendEvent).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                container.setCode("1");
                container.setMsg("MainActivity Send Message");
                try {
    ...
    private TermiteCallBack callBack = new TermiteCallBack.Stub() {
        ...
        public void receiveEventMmessageListener(TermiteEventContainer msg) throws RemoteException {
            if (msg != null) {
                Log.d("MainActivity", "接收到到消息为：" + msg.getMsg());
            }
        }
    };
